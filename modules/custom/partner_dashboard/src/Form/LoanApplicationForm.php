  ...
  */
        ...
        try {
            ...
            $notification = \Drupal::service('mangalpath_module.notification');
              ...
              $form_state->getValue('field_first_name').' submitted a loan enquiry.',
            ...
            $mailManager->mail(
                $module,
                'user_thank_you',
                $form_state->getValue('field_loan_email_address'),
                $langcode,
                $params
            );
          ...
          Name : {$title}
          Email : {$form_state->getValue('field_loan_email_address')}
          Phone : {$form_state->getValue('field_phone_number')}
          Message : {$form_state->getValue('field_purpose_of_loan')}
          Related: 'User Loan inqueries Form......'
          ";
